  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.info}>
        <Text style={styles.nameText}>Điện Thoại Vsmart Joy 3 - Hàng chính hãng</Text>
        <View style={styles.starGroup}>
          ...
          <Text style={styles.nameText, {marginLeft:20}}>(Xem 828 đánh giá)</Text>
        </View>
        <View style={{flexDirection:'row', marginTop: '10px', alignItems:'center'}}>
        ...
        <View style={{flexDirection:'row', marginTop: '10px'}}>
          ...
          <View style={{marginLeft: '13px'}}>
            <Image style={{position:'absolute', top: '-30%', left:'-55%'}} 
      ...
      <View style={styles.button}>
        <Image style={{position: 'absolute', right: 40, bottom: 102}} source={require('../assets/Vector3.png')}></Image>
        <TouchableOpacity style={styles.selectColor} onPress={() => navigation.navigate('SelectColor')}>
